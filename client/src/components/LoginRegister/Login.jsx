...
const Login = (props) => {
  ...
  const check = async (e) => {
    ...
    if (role === "user") {
      ...
      try {
        const response = await axios.post("https://quizbackend-3-fjmj.onrender.com/login-user", {
          email: email,
          password: pass,
        });
      ...
      try {
        const response = await axios.post("https://quizbackend-3-fjmj.onrender.com/login-admin", {
          email: email,
          password: pass,
        });
        // console.log(response);
